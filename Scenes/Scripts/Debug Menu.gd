...
func _ready():
	...
	rotate_speed_spin_box.connect("value_changed",game,"_on_RotateSpeedSpinBox_value_changed")
	timer_wait_time_spin_box.connect("value_changed",game,"_on_TimerWaitTimeSpinBox_value_changed")
	spawnpoint_number_spin_box.connect("value_changed",game,"_on_SpawnpointNumberSpinBox_value_changed")
	radius_spin_box.connect("value_changed",game,"_on_RadiusSpinBox_value_changed")
	bullet_speed_spin_box.connect("value_changed",game,"_on_BulletSpeedSpinBox_value_changed")
	turns_checkbutton.connect("toggled",game,"_on_TurnsCheckButton_toggled")
	turn_timer_spin_box.connect("value_changed",game,"_on_TurnTimerWaitTime_value_changed")
